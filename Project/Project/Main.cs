                ...
                if (obj[i].getUser() == currentUser.Username)
                {
                    if (obj[i].getEvent() == monthCalendar.SelectionStart)
                    {
                        if(obj[i].TimeSlot1 != "")
                        {
                            ...
                            lbl1stLocation.Text = "Location : " + obj[i].LocationEvent1;
                        ...
                        if (obj[i].TimeSlot2 != "")
                        {
                            ...
                            lbl1stLocation.Text = "Location : " +  obj[i].LocationEvent2;
                        ...
                        if (obj[i].TimeSlot3 != "")
                        {
                            ...
                            lbl1stLocation.Text = "Location : " + obj[i].LocationEvent3;
                        ...
                        if (obj[i].TimeSlot4 != "")
                        {
                            ...
                            lbl1stLocation.Text = "Location : " + obj[i].LocationEvent4;
                        ...
                        if (obj[i].TimeSlot5 != "")
                        {
                            ...
                            lbl1stLocation.Text = "Location : " + obj[i].LocationEvent5;
                        ...
                        if (obj[i].TimeSlot6 != "")
                        {
                            ...
                            lbl1stLocation.Text = "Location : " + obj[i].LocationEvent6;
                        ...
                        if (obj[i].TimeSlot7 != "")
                        {
                            ...
                            lbl1stLocation.Text = "Location : " +  obj[i].LocationEvent7;
                        ...
                        if (obj[i].TimeSlot8 != "")
                        {
                            ...
                            lbl1stLocation.Text = "Location : " +  obj[i].LocationEvent8;
                        ...
                        if (obj[i].TimeSlot9 != "")
                        {
                            ...
                            lbl1stLocation.Text = "Location : " + obj[i].LocationEvent9;
                        ...
                        if (obj[i].TimeSlot10 != "")
                        {
                            ...
                            lbl1stLocation.Text = "Location : " + obj[i].LocationEvent10;
                        ...
                        if (obj[i].TimeSlot11 != "")
                        {
                            ...
                            lbl1stLocation.Text = "Location : " + obj[i].LocationEvent11;
                ...
                if(obj[i].getUser() == currentUser.Username)
                {
                    if(obj[i].getEvent() == monthCalendar.SelectionStart)
                    {
                        if (obj[i].TimeSlot11 != "")
                        {
                            ...
                            lblLastLocation.Text = "Location : " + obj[i].LocationEvent11;
                            return obj[i].TimeSlot11;
                        }
                        if (obj[i].TimeSlot10 != "")
                        {
                            ...
                            lblLastLocation.Text = "Location : " + obj[i].LocationEvent10;
                            return obj[i].TimeSlot10;
                        }
                        if (obj[i].TimeSlot9 != "")
                        {
                            ...
                            lblLastLocation.Text = "Location : " + obj[i].LocationEvent9;
                            return obj[i].TimeSlot9;
                        }
                        if (obj[i].TimeSlot8 != "")
                        {
                            ...
                            lblLastLocation.Text = "Location : " + obj[i].LocationEvent8;
                            return obj[i].TimeSlot8;
                        }
                        if (obj[i].TimeSlot7 != "")
                        {
                            ...
                            lblLastLocation.Text = "Location : " + obj[i].LocationEvent7;
                            return obj[i].TimeSlot7;
                        }
                        if (obj[i].TimeSlot6 != "")
                        {
                            ...
                            lblLastLocation.Text = "Location : " + obj[i].LocationEvent6;
                            return obj[i].TimeSlot6;
                        }
                        if (obj[i].TimeSlot5 != "")
                        {
                            ...
                            lblLastLocation.Text = "Location : " + obj[i].LocationEvent5;
                            return obj[i].TimeSlot5;
                        }
                        if (obj[i].TimeSlot4 != "")
                        {
                            ...
                            lblLastLocation.Text = "Location : " + obj[i].LocationEvent4;
                            return obj[i].TimeSlot4;
                        }
                        if (obj[i].TimeSlot3 != "")
                        {
                            ...
                            lblLastLocation.Text = "Location : " + obj[i].LocationEvent3;
                            return obj[i].TimeSlot3;
                        }
                        if (obj[i].TimeSlot2 != "")
                        {
                            ...
                            lblLastLocation.Text = "Location : " + obj[i].LocationEvent2;
                            return obj[i].TimeSlot2;
                        }
                        if (obj[i].TimeSlot1 != "")
                        {
                            ...
                            lblLastLocation.Text = "Location : " + obj[i].LocationEvent1;
                            return obj[i].TimeSlot1;
                        }
                    }
                }
